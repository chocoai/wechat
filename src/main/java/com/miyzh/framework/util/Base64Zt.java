...
/**
 * <p>
 * Encodes and decodes to and from Base64zt notation.
 * </p>
 * <p>
 * Homepage: <a href="http://iharder.net/Base64zt">http://iharder.net/Base64zt</a>.
 * </p>
 * 
 * <p>
 * Example:
 * </p>
 * 
 * <code>String encoded = Base64zt.encode( myByteArray );</code> <br />
 * <code>byte[] myByteArray = Base64zt.decode( encoded );</code>
 * 
 * <p>
 ...
 * I've got Base64zt set to this behavior now, although earlier versions broke
 * lines by default.
 * </p>
 * 
 * <p>
 * The constants defined in Base64zt can be OR-ed together to combine options, so
 * you might make a call like this:
 * </p>
 * 
 * <code>String encoded = Base64zt.encodeBytes( mybytes, Base64zt.GZIP | Base64zt.DO_BREAK_LINES );</code>
 * <p>
 ...
 * Also...
 * </p>
 * <code>String encoded = Base64zt.encodeBytes( crazyString.getBytes() );</code>
 * 
 * 
 * 
 * <p>
 ...
 * Base64zt.OutputStream closed the Base64zt encoding (by padding with equals signs)
 ...
 * encoding/decoding from one file to the next. Also added these Base64zt
 * dialects:
 * <ol>
 * <li>The default is RFC3548 format.</li>
 * <li>Calling Base64zt.setFormat(Base64zt.Base64zt_FORMAT.URLSAFE_FORMAT) generates
 * URL and file name friendly format as described in Section 4 of RFC3548.
 * http://www.faqs.org/rfcs/rfc3548.html</li>
 * <li>Calling Base64zt.setFormat(Base64zt.Base64zt_FORMAT.ORDERED_FORMAT) generates
 ...
 * encoding if you need to embed Base64zt data in an otherwise "normal" stream
 * (like an XML file).</li>
 ...
 * href="http://iharder.net/Base64zt">http://iharder.net/Base64zt</a> periodically
...
public class Base64Zt {
	...
	/**
	 * Encode using Base64zt-like encoding that is URL- and Filename-safe as
	 ...
	 * data encoded this way is <em>not</em> officially valid Base64zt, or at the
	 * very least should not be called Base64zt without also specifying that is
	 * was encoded using the URL- and Filename-safe dialect.
	 */
	public final static int URL_SAFE = 16;

	/**
	 * Encode using the special "ordered" dialect of Base64zt described here: <a
	...
	/** Maximum line length (76) of Base64zt output. */
	...
	/**
	 * Translates a Base64zt value to either its 6-bit reconstruction value or a
	...
	/**
	 * Used in decoding URL- and Filename-safe dialects of Base64zt.
	 */
	...
	/**
	 * Used in decoding the "ordered" dialect of Base64zt.
	 */
	 ...
	 * returns a four-byte array in Base64zt notation. The actual number of
	 ...
	 * @return four byte array in Base64zt notation.
	 * @since 1.5.1
	 */
	 ...
	 * resulting four Base64zt bytes to <var>destination</var>. The source and
	...
	/**
	 * Performs Base64zt encoding on the <code>raw</code> ByteBuffer, writing it
	...
	public static void encode(java.nio.ByteBuffer raw,
		...
		while (raw.hasRemaining()) {
			...
			raw.get(raw3, 0, rem);
			Base64Zt.encode3to4(enc4, raw3, rem, Base64Zt.NO_OPTIONS);
			encoded.put(enc4);
		} // end input remaining
	}
	...
	/**
	 * Serializes an object and returns the Base64zt-encoded version of that
	 * serialized object.
	 * 
	 * <p>
	 ...
	 * @return The Base64zt-encoded object
	 ...
	 * </pre>
	 * <p>
	 * Example: <code>encodeObject( myObj, Base64zt.GZIP )</code> or
	 * <p>
	 * Example:
	 * <code>encodeObject( myObj, Base64zt.GZIP | Base64zt.DO_BREAK_LINES )</code>
	 * 
	 * @param serializableObject
	 *            The object to encode
	 * @param options
	...
	public static String encodeObject(java.io.Serializable serializableObject,
		...
		try {
			// ObjectOutputStream -> (GZIP) -> Base64zt -> ByteArrayOutputStream
			baos = new java.io.ByteArrayOutputStream();
			b64os = new Base64Zt.OutputStream(baos, ENCODE | options);
			if ((options & GZIP) != 0) {
				// Gzip
	...
	/**
	 * Encodes a byte array into Base64zt notation. Does not GZip-compress data.
	 * 
	 * @param source
	 *            The data to convert
	 * @return The data in Base64zt-encoded form
	 * @throws NullPointerException
	...
	/**
	 * Encodes a byte array into Base64zt notation.
	 * <p>
	 * Example options:
	 * 
	 * <pre>
	 ...
	 * </pre>
	 * <p>
	 * Example: <code>encodeBytes( myData, Base64zt.GZIP )</code> or
	 * <p>
	 * Example:
	 * <code>encodeBytes( myData, Base64zt.GZIP | Base64zt.DO_BREAK_LINES )</code>
	 * 
	 * 
	 * <p>
	 ...
	 * @param options
	 *            Specified options
	 * @return The Base64zt-encoded data as a String
	 * @see Base64Zt#GZIP
	 * @see Base64Zt#DO_BREAK_LINES
	 * @throws java.io.IOException
	 *             if there is an error
	 ...
	 * @param source
	 *            The data to convert
	 * @return The Base64zt-encoded data as a byte[] (of ASCII characters)
	 * @throws NullPointerException
	 *             if source array is null
	 * @since 2.3.1
	 */
	...
	public static byte[] encodeBytesToBytes(byte[] source, int off, int len,
		...
		if ((options & GZIP) != 0) {
			java.io.ByteArrayOutputStream baos = null;
			java.util.zip.GZIPOutputStream gzos = null;
			Base64Zt.OutputStream b64os = null;

			try {
				// GZip -> Base64zt -> ByteArray
				baos = new java.io.ByteArrayOutputStream();
				b64os = new Base64Zt.OutputStream(baos, ENCODE | options);
				gzos = new java.util.zip.GZIPOutputStream(b64os);
	...
	public static byte[] decode(byte[] source) throws java.io.IOException {
		byte[] decoded = null;
		// try {
		decoded = decode(source, 0, source.length, Base64Zt.NO_OPTIONS);
		// } catch( java.io.IOException ex ) {
		// assert false :
	...
	public static byte[] decode(byte[] source, int off, int len, int options)
		...
		if (len == 0) {
			...
			throw new IllegalArgumentException(
					"Base64zt-encoded string must have at least four characters, but length specified was "
							+ len);
		} // end if
		...
		for (i = off; i < off + len; i++) { // Loop through source
			...
			// White space, Equals sign, or legit Base64zt character
			...
			if (sbiDecode >= WHITE_SPACE_ENC) {
				...
				// There's a bad input character in the Base64zt stream.
				throw new java.io.IOException(
						String.format(
								"Bad Base64zt input character decimal %d in array position %d",
								((int) source[i]) & 0xFF, i));
			} // end else:
	...
	/**
	 * Decodes data from Base64zt notation, automatically detecting
	...
	/**
	 * Attempts to decode Base64zt data and deserialize a Java Object within.
	 * Returns <tt>null</tt> if there was an error.
	 * 
	 * @param encodedObject
	 *            The Base64zt data to decode
	 ...
	 * 
	 * @param dataToEncode
	 *            byte array of data to encode in Base64zt form
	 * @param filename
	...
	public static void encodeToFile(byte[] dataToEncode, String filename)
		...
		Base64Zt.OutputStream bos = null;
		try {
			bos = new Base64Zt.OutputStream(
					new java.io.FileOutputStream(filename), Base64Zt.ENCODE);
	 ...
	 * 
	 * @param dataToDecode
	 *            Base64zt-encoded data as a string
	 * @param filename
	...
	public static void decodeToFile(String dataToDecode, String filename)
		...
		try {
			bos = new Base64Zt.OutputStream(
					new java.io.FileOutputStream(filename), Base64Zt.DECODE);
	...
	/**
	 * Convenience method for reading a Base64zt-encoded file and decoding it.
	 * 
	 * <p>
	 * As of v 2.3, if there is a error, the method will throw an
	 * java.io.IOException. <b>This is new to v2.3!</b> In earlier versions, it
	...
	public static byte[] decodeFromFile(String filename)
		...
		try {
			...
			// Open a stream
			bis = new Base64Zt.InputStream(new java.io.BufferedInputStream(
					new java.io.FileInputStream(file)), Base64Zt.DECODE);
	...
	/**
	 * Convenience method for reading a binary file and Base64zt-encoding it.
	 * 
	 * <p>
	 * As of v 2.3, if there is a error, the method will throw an
	 * java.io.IOException. <b>This is new to v2.3!</b> In earlier versions, it
	 ...
	 * @return Base64zt-encoded string
	 * @throws java.io.IOException
	 *             if there is an error
	 * @since 2.1
	 */
	public static String encodeFromFile(String filename)
		...
		try {
			...
			// Open a stream
			bis = new Base64Zt.InputStream(new java.io.BufferedInputStream(
					new java.io.FileInputStream(file)), Base64Zt.ENCODE);
	...
	public static void encodeFileToFile(String infile, String outfile)
		...
		String encoded = Base64Zt.encodeFromFile(infile);
	...
	public static void decodeFileToFile(String infile, String outfile)
		...
		byte[] decoded = Base64Zt.decodeFromFile(infile);
		java.io.OutputStream out = null;
		try {
			out = new java.io.BufferedOutputStream(
					new java.io.FileOutputStream(outfile));
	...
	/**
	 * A {@link Base64Zt.InputStream} will read data from another
	 * <tt>java.io.InputStream</tt>, given in the constructor, and encode/decode
	 * to/from Base64zt notation on the fly.
	 * 
	 * @see Base64Zt
	 * @since 1.3
	 */
	public static class InputStream extends java.io.FilterInputStream {
		...
		/**
		 * Constructs a {@link Base64Zt.InputStream} in DECODE mode.
		 * 
		 * @param in
		...
		/**
		 * Constructs a {@link Base64Zt.InputStream} in either ENCODE or DECODE
		 * mode.
		 * <p>
		 * Valid options:
		 * 
		 ...
		 * </pre>
		 * <p>
		 * Example: <code>new Base64zt.InputStream( in, Base64zt.DECODE )</code>
		 * 
		 * 
		 * @param in
		 *            the <tt>java.io.InputStream</tt> from which to read data.
		...
		/**
		 * Reads enough of the input stream to convert to/from Base64zt and
		...
		public int read() throws java.io.IOException {
			...
			if (position < 0) {
				...
				// Else decoding
					...
					if (i == 4) {
						...
						throw new java.io.IOException(
								"Improperly padded Base64zt input.");
					} // end
			...
			// Else error
				...
				throw new java.io.IOException(
						"Error in Base64zt code reading stream.");
			} // end else
		} // end read
	...
	/**
	 * A {@link Base64Zt.OutputStream} will write data to another
	 * <tt>java.io.OutputStream</tt>, given in the constructor, and
	 * encode/decode to/from Base64zt notation on the fly.
	 * 
	 * @see Base64Zt
	 * @since 1.3
	 */
	public static class OutputStream extends java.io.FilterOutputStream {
		...
		/**
		 * Constructs a {@link Base64Zt.OutputStream} in ENCODE mode.
		 * 
		 * @param out
		...
		/**
		 * Constructs a {@link Base64Zt.OutputStream} in either ENCODE or DECODE
		 * mode.
		 * <p>
		 * Valid options:
		 * 
		 ...
		 * </pre>
		 * <p>
		 * Example: <code>new Base64zt.OutputStream( out, Base64zt.ENCODE )</code>
		 * 
		 * @param out
		 *            the <tt>java.io.OutputStream</tt> to which data will be
		 *            written.
		...
		/**
		 * Writes the byte to the output stream after converting to/from Base64zt
		...
		public void write(int theByte) throws java.io.IOException {
			...
			// Else, Decoding
				...
				// Meaningful Base64zt character?
				if (decodabet[theByte & 0x7f] > WHITE_SPACE_ENC) {
					buffer[position++] = (byte) theByte;
					if (position >= bufferLength) { // Enough to output.

						int len = Base64Zt.decode4to3(buffer, 0, b4, 0, options);
						out.write(b4, 0, len);
						position = 0;
					} // end if: enough to output
				} // end if: meaningful Base64zt character
				else if (decodabet[theByte & 0x7f] != WHITE_SPACE_ENC) {
					throw new java.io.IOException(
							"Invalid character in Base64zt data.");
		 ...
		 *             if there's an error.
		 */
		public void flushBase64zt() throws java.io.IOException {
			if (position > 0) {
				if (encode) {
					...
					throw new java.io.IOException(
							"Base64zt input not properly padded.");
				} // end else: decoding
		 ...
		 * a piece of Base64zt-encoded data in a stream.
		 * 
		 * @throws java.io.IOException
		 ...
		 * piece of Base64zt-encoded data in a stream.
		 * 
		 * @since 1.5.1
		 */
